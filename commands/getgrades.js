        ...
        if(!helper.userRegistered(message.author)){
            ...
            helper.httpsGetJSON2(url).then((result) => {
                    ...
                    for (let j = 0; j < result.length; j++){
                        ...
                        if (courseIDs[i] == cid){
                            ...
                            if (grade == null || grade == undefined){
                                ...
                                embeds.push(new Discord.MessageEmbed().addField(`${courseNames[i]}`, "Your instructor has not put in a total grade for this course.", false));
                                break;
                            }
                            else {
                                //embed.addField(`${courseNames[i]}`, `${grade}%`, false);
                                embeds.push(new Discord.MessageEmbed().addField(`${courseNames[i]}`, `${grade}%`, false));
                                break;
                            }
                ...
                new Pagination.Embeds()
                    ...
                    .setDescription(`Here are the grades for: ${message.author}`)
                    .setThumbnail('https://upload.wikimedia.org/wikipedia/en/thumb/a/a2/North_Texas_Mean_Green_logo.svg/1200px-North_Texas_Mean_Green_logo.svg.png')
